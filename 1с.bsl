...
Функция НоменклатураТаблицаЗначений()
	...
	Результат.Колонки.Добавить( "ТоварнаяКатегория", УстановитьТипДанных( Тип("Строка"), 100 ) );
	...
	Результат.Колонки.Добавить( "ЦеноваяГруппа", УстановитьТипДанных( Тип("Строка") ), 50 );
...
КонецФункции
Функция ТоварныеКатегорииТаблицаЗначений()
...
КонецФункции
Функция ЦеновыеГруппыТаблицаЗначений()
...
КонецФункции
Функция ПриобретениеТоваровУслугЗаголовокТаблицаЗначений()
	Результат = Новый ТаблицаЗначений;
	
	Результат.Колонки.Добавить( "Ключ", УстановитьТипДанных( Тип("Строка"), 8 ) );
	Результат.Колонки.Добавить( "Номер", УстановитьТипДанных( Тип("Строка"), 11 ) );
	Результат.Колонки.Добавить( "Дата", УстановитьТипДанных( Тип("Дата") ) );
	Результат.Колонки.Добавить( "Контрагент", УстановитьТипДанных( Тип("Строка"), 12 ) );
	Результат.Колонки.Добавить( "Партнер", УстановитьТипДанных( Тип("Строка"), 50 ) );
	Результат.Колонки.Добавить( "Склад", УстановитьТипДанных( Тип("Строка"), 50 ) );
	Результат.Колонки.Добавить( "Валюта", УстановитьТипДанных( Тип("Строка"), 3 ) );
	Результат.Колонки.Добавить( "СуммаДокумента", УстановитьТипДанных( Тип("Число"), 15, 2 ) );
	Результат.Колонки.Добавить( "Менеджер", УстановитьТипДанных( Тип("Строка"), 100 ) );
	Результат.Колонки.Добавить( "ЦенаВключаетНДС", УстановитьТипДанных( Тип("Булево") ) );
	Результат.Колонки.Добавить( "Комментарий", УстановитьТипДанных( Тип("Строка"), 500 ) );
	Результат.Колонки.Добавить( "ДатаПлатежа", УстановитьТипДанных( Тип("Дата") ) );
	Результат.Колонки.Добавить( "НомерВходящегоДокумента", УстановитьТипДанных( Тип("Строка"), 3 ) );
	Результат.Колонки.Добавить( "ДатаВходящегоДокумента", УстановитьТипДанных( Тип("Строка"), 3 ) );
	Результат.Колонки.Добавить( "Автор", УстановитьТипДанных( Тип("Строка"), 100 ) );
		
	Возврат Результат;
		
КонецФункции
Функция ПриобретениеТоваровУслугДеталиТаблицаЗначений()
	Результат = Новый ТаблицаЗначений;
	
	Результат.Колонки.Добавить( "Ключ", УстановитьТипДанных( Тип("Строка"), 8 ) );
	Результат.Колонки.Добавить( "MODCOMM ТФО", УстановитьТипДанных( Тип("Строка"), 50 ) );
	Результат.Колонки.Добавить( "Количество", УстановитьТипДанных( Тип("Число"), 15, 3 ) );
	Результат.Колонки.Добавить( "Цена", УстановитьТипДанных( Тип("Число"), 12 ) );
	Результат.Колонки.Добавить( "Сумма", УстановитьТипДанных( Тип("Число"), 12 ) );
	Результат.Колонки.Добавить( "НомерГТД", УстановитьТипДанных( Тип("Число"), 30 ) );
	Результат.Колонки.Добавить( "СтранаПроисхождения", УстановитьТипДанных( Тип("Строка"), 3 ) );
...
Процедура ЗаполнитьВосстанавливаемыеДанные( СтруктураВосстанавливаемыхДанных, НаборДанных = Неопределено )
	...
	Если НаборДанных = "Номенклатура" Или НаборДанных = Неопределено Тогда
		...
		ИнформацияОВосстановлении = СтруктураВосстанавливаемыхДанных.Добавить();
		ИнформацияОВосстановлении.Свойство = "ТоварнаяКатегория"; // Пришло свойство
		ИнформацияОВосстановлении.Ключ = "Наименование"; // Искать по этому реквизиту
		ИнформацияОВосстановлении.ТипОбъекта = "Справочник"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Объект = "ТоварныеКатегории"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Алиас = "ТоварныеКатегории"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Значение = "Ссылка"; // Вернуть этот реквизит

		ИнформацияОВосстановлении = СтруктураВосстанавливаемыхДанных.Добавить();
		ИнформацияОВосстановлении.Свойство = "ЦеноваяГруппа"; // Пришло свойство
		ИнформацияОВосстановлении.Ключ = "Наименование"; // Искать по этому реквизиту
		ИнформацияОВосстановлении.ТипОбъекта = "Справочник"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Объект = "ЦеновыеГруппы"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Алиас = "ЦеновыеГруппы"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Значение = "Ссылка"; // Вернуть этот реквизит
	
	КонецЕсли; // Номенклатура
	
	Если НаборДанных = "ПриобретениеТоваровУслугЗаголовки" Тогда
		...
		ИнформацияОВосстановлении = СтруктураВосстанавливаемыхДанных.Добавить();
		ИнформацияОВосстановлении.Свойство = "Склад"; // Пришло свойство
		ИнформацияОВосстановлении.Ключ = "Наименование"; // Искать по этому реквизиту
		ИнформацияОВосстановлении.ТипОбъекта = "Справочник"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Объект = "Склады"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Алиас = "Склады"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Значение = "Ссылка"; // Вернуть этот реквизит	

		ИнформацияОВосстановлении = СтруктураВосстанавливаемыхДанных.Добавить();
		ИнформацияОВосстановлении.Свойство = "Автор"; // Пришло свойство
		ИнформацияОВосстановлении.Ключ = "Наименование"; // Искать по этому реквизиту
		ИнформацияОВосстановлении.ТипОбъекта = "Справочник"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Объект = "Пользователи"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Алиас = "Пользователи"; // Искать в этом объекте метаданных
	...
	Если НаборДанных = "ПриобретениеТоваровУслугДетали" Тогда

		ИнформацияОВосстановлении = СтруктураВосстанавливаемыхДанных.Добавить();
		ИнформацияОВосстановлении.Свойство = "Номенклатура"; // Пришло свойство
		ИнформацияОВосстановлении.Ключ = "MODCOMM_ТФО"; // Искать по этому реквизиту
		ИнформацияОВосстановлении.ТипОбъекта = "Справочник"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Объект = "Номенклатура"; // Искать в этом объекте метаданных
		ИнформацияОВосстановлении.Алиас = "Номенклатура"; // Искать в этом объекте метаданных
...
Функция ВосстановитьШтрихкоды( Данные )
	...
	Запрос.Текст = "ВЫБРАТЬ
			...
			|	ЕСТЬNULL(УпаковкиЕдиницыИзмерения.Ссылка, ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)) КАК Упаковка,
			|	ВТ_Штрихкоды.Штрихкод КАК Штрихкод
			|ИЗ
			|	ВТ_Штрихкоды КАК ВТ_Штрихкоды
			|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.УпаковкиЕдиницыИзмерения КАК УпаковкиЕдиницыИзмерения
			|		ПО (ВТ_Штрихкоды.Упаковка = УпаковкиЕдиницыИзмерения.ЕдиницаИзмерения.Код)
			|			И (УпаковкиЕдиницыИзмерения.Владелец ССЫЛКА Справочник.Номенклатура)
			|			И (УпаковкиЕдиницыИзмерения.Владелец.MODCOMM_ТФО = ВТ_Штрихкоды.MODCOMM_ТФО)
...
Функция ВосстановитьТоварныеКатегории( Данные )
	
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
			|	ВременныеТоварныеКатегории.ВидНоменклатуры КАК ВидНоменклатуры,
			|	ВременныеТоварныеКатегории.Наименование КАК Наименование
			|ПОМЕСТИТЬ ВТ_ТоварныеКатегории
			|ИЗ
			|	&ТаблицаВременныхТоварныхКатегорий КАК ВременныеТоварныеКатегории
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	ВидыНоменклатуры.Ссылка КАК ВидНоменклатуры,
			|	ВТ_ТоварныеКатегории.Наименование КАК Наименование
			|ИЗ
			|	ВТ_ТоварныеКатегории КАК ВТ_ТоварныеКатегории
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ВидыНоменклатуры КАК ВидыНоменклатуры
			|		ПО ВТ_ТоварныеКатегории.ВидНоменклатуры = ВидыНоменклатуры.Наименование
			|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ТоварныеКатегории КАК ТоварныеКатегории
			|		ПО ВТ_ТоварныеКатегории.Наименование = ТоварныеКатегории.Наименование
			|			И ВТ_ТоварныеКатегории.ВидНоменклатуры = ТоварныеКатегории.Владелец.Наименование
			|ГДЕ
			|	ТоварныеКатегории.Ссылка ЕСТЬ NULL";
	
	Запрос.УстановитьПараметр( "ТаблицаВременныхТоварныхКатегорий", Данные );
	Попытка
		Результат = Запрос.Выполнить().Выгрузить( ОбходРезультатаЗапроса.Прямой );
	Исключение
		Результат = Новый ТаблицаЗначений;
...
Функция ВосстановитьЦеновыеГруппы( Данные )
	
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
		|	ВременныеЦеновыеГруппы.ЦеноваяГруппа КАК ЦеноваяГруппа
		|ПОМЕСТИТЬ ВТ_ЦеновыеГруппы
		|ИЗ
		|	&ТаблицаВременныхЦеновыхГрупп КАК ВременныеЦеновыеГруппы
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|		ПО (ВТ_ЦеновыеГруппы.ЦеноваяГруппа = ЦеновыеГруппы.Наименование)
		|ГДЕ
		|	ЦеновыеГруппы.Ссылка ЕСТЬ NULL";
	
	Запрос.УстановитьПараметр( "ТаблицаВременныхЦеновыхГрупп", Данные );
	Попытка
		Результат = Запрос.Выполнить().Выгрузить( ОбходРезультатаЗапроса.Прямой );
	Исключение
		Результат = Новый ТаблицаЗначений;
...
Функция ФизическиеЛицаЗаписать(Запрос)
	...
	Если ФизическиеЛица = Неопределено Или ТипЗнч(ФизическиеЛица) <> Тип("Массив")  Тогда 
		...
		РезультатРаботы.Ошибки.Добавить( СтрокаJSON );
	...
	Для Каждого ФизическоеЛицо Из ФизическиеЛица Цикл 
		...
		Если ПустаяСтрока( ФизическоеЛицо.Фамилия ) Или ПустаяСтрока( ФизическоеЛицо.Имя ) Или ПустаяСтрока( ФизическоеЛицо.Отчество ) Тогда 
			...
			РезультатРаботы.Ошибки.Добавить( "Неполное ФИО: " + Человек.Наименование );
		...
		Если РезультатРаботы.Сохранить Тогда
			...
			Для Каждого КИ Из ФизическоеЛицо.КонтактнаяИнформация Цикл 
				...
				Если ТипКонтактнойИнформации = Неопределено Тогда
					...
					//РезультатРаботы.Ошибки.Добавить( "Неверный тип контактной информации: " + КИ.Тип );
					РезультатРаботы.Сохранить = Ложь;
				...
				Если ЧеловекКонтактнаяИнформация.Вид = Справочники.ВидыКонтактнойИнформации.ПустаяСсылка() Тогда
					...
					//РезультатРаботы.Ошибки.Добавить( "Неверный вид контактной информации: " + КИ.Вид );
					РезультатРаботы.Сохранить = Ложь;
	...
	Пока Выборка.Следующий() Цикл 
		...
		MODCOMM_ОбщегоНазначения.КоличествоИСумма( РезультатРаботы );
		
	КонецЦикла; // Выборка
	
	MODCOMM_ОбщегоНазначения.ЗавершитьРаботуПроцедуры( РезультатРаботы );
	// Готовим данные 
	Ответ.Заголовки.Вставить( "Content-Type", "application/json; charset=utf-8" );
	Ответ.УстановитьТелоИзСтроки(  MODCOMM_ОбщегоНазначения.ПолучитьСтрокуJSONИзСтруктуры(РезультатРаботы) ); 
	Возврат Ответ; 
...
Функция КонтрагентыПартнерыЗаписать(Запрос)
	...
	Для Каждого КонтрагентПартнер Из КонтрагентыПартнеры Цикл
		...
		Для Каждого Элемент Из КонтрагентПартнер.КонтактнаяИнформация Цикл 
			...
			Если ТипКонтактнойИнформации = Неопределено Тогда
				...
				//РезультатРаботы.Ошибки.Добавить( "Неверный тип контактной информации: " + Элемент.Тип );
				РезультатРаботы.Сохранить = Ложь;
			...
			Если НоваяКонтактнаяИнформация.Вид = Справочники.ВидыКонтактнойИнформации.ПустаяСсылка() Тогда
				...
				//РезультатРаботы.Ошибки.Добавить( "Неверный вид контактной информации: " + Элемент.Вид );
				РезультатРаботы.Сохранить = Ложь;
	...
	Попытка
		//РезультатРаботы.Ошибки.Добавить( ЗапросКБазе.Текст );
		Выборка = ЗапросКБазе.Выполнить().Выбрать();
	Исключение
	    РезультатРаботы.Ошибки.Добавить( ОписаниеОшибки() );
		РезультатРаботы.Сохранить = Ложь;
	КонецПопытки;
	...
	Если РезультатРаботы.Сохранить Тогда 
		...
		РезультатРаботы.Ошибки.Добавить( Строка(Выборка.Количество()) );
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Не ЗначениеЗаполнено( Выборка.Ссылка ) Тогда
				...
				//РезультатРаботы.Ошибки.Добавить( "Добавлен: " + НовыйПартнер.Код + ":" + НовыйПартнер.Наименование + " " );
			...
			Иначе 
				...
				//РезультатРаботы.Ошибки.Добавить( "Изменен: " + НовыйПартнер.Код + ":" + НовыйПартнер.Наименование + " " + Строка(ТипЗнч(Выборка.ОсновнойМенеджер)) + Строка(Выборка.ОсновнойМенеджер) );
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ЗначениеЗаполнено( Выборка.Ссылка ) Тогда
			...
			//РезультатРаботы.Ошибки.Добавить( "Добавлен: " + НовыйКонтрагент.Код + ":" + НовыйКонтрагент.Наименование + " " + НовыйКонтрагент.Партнер.Код + " " + НовыйКонтрагент.Партнер );
		...
		Иначе
			...
			//РезультатРаботы.Ошибки.Добавить( "Изменен: " + НовыйКонтрагент.Код + ":" + НовыйКонтрагент.Наименование + " " );
...
Функция НоменклатураЗаписать(Запрос)
	...
	ВременныеТоварныеКатегории = ТоварныеКатегорииТаблицаЗначений();
	ВременныеЦеновыеГруппы = ЦеновыеГруппыТаблицаЗначений();
	...
	#Область ВосстановлениеПервогоУровня
	// Восстанавливаем данные	
	Для Каждого СтрокаНоменклатура Из Номенклатура Цикл
		...
		СтрокаВременнаяНоменклатура.ТоварнаяКатегория = СтрокаНоменклатура.ТоварнаяКатегория; 
		СтрокаВременнаяНоменклатура.ЦеноваяГруппа = СтрокаНоменклатура.ЦеноваяГруппа;
		...
		// Заполняем таблицу временных товарных категорий
		Если СтрокаНоменклатура.Свойство("ТоварнаяКатегория") И Не ПустаяСтрока( СтрокаНоменклатура.ТоварнаяКатегория ) Тогда 
			СтрокаТоварныхКатегорий	= ВременныеТоварныеКатегории.Добавить();
			СтрокаТоварныхКатегорий.ВидНоменклатуры = СтрокаВременнаяНоменклатура.ВидНоменклатуры;
			СтрокаТоварныхКатегорий.Наименование = НРег( СтрокаНоменклатура.ТоварнаяКатегория );
		КонецЕсли;
				
		// Заполняем таблицу временных ценновые группы		
		Если СтрокаНоменклатура.Свойство("ЦеноваяГруппа") И Не ПустаяСтрока( СтрокаНоменклатура.ЦеноваяГруппа ) Тогда 
			СтрокаЦеновыхГрупп = ВременныеЦеновыеГруппы.Добавить();
			СтрокаЦеновыхГрупп.ЦеноваяГруппа = СтрокаНоменклатура.ЦеноваяГруппа;
		КонецЕсли;
	...
	#Область ЗагрузкаЦенновыхГрупп
	
	ВременныеЦеновыеГруппы.Свернуть("ЦеноваяГруппа");
	ЦеновыеГруппы = ВосстановитьЦеновыеГруппы( ВременныеЦеновыеГруппы );
	Для Каждого Элемент Из ЦеновыеГруппы Цикл
		
		НоваяЦеноваяГруппа = Справочники.ЦеновыеГруппы.СоздатьЭлемент();
		НоваяЦеноваяГруппа.Наименование = Элемент.ЦеноваяГруппа;
		НоваяЦеноваяГруппа.Записать();
		
	КонецЦикла;
	
	#КонецОбласти
	
	#Область ЗагрузкаТоварныхКатегорий
	
	ВременныеТоварныеКатегории.Свернуть("ВидНоменклатуры,Наименование");
	ТоварныеКатегории = ВосстановитьТоварныеКатегории( ВременныеТоварныеКатегории );
	Для Каждого Элемент Из ТоварныеКатегории Цикл 
		
		НоваяТоварнаяКатегория = Справочники.ТоварныеКатегории.СоздатьЭлемент();
		НоваяТоварнаяКатегория.Владелец = Элемент.ВидНоменклатуры;
		НоваяТоварнаяКатегория.Наименование = Элемент.Наименование;
		
		НоваяТоварнаяКатегория.Записать();
	КонецЦикла;
	...
	РезультатРаботы.Ошибки.Добавить( "Штрихкоды: " + Строка(Штрихкоды.Количество()) );
	Для Каждого Элемент Из Штрихкоды Цикл 
		...
		Исключение
		    РезультатРаботы.Ошибки.Добавить( "Штрихкоды: " + ОписаниеОшибки() );
		КонецПопытки;
	КонецЦикла;
...
Функция ПриобретениеТоваровУслугЗаписать(Запрос)
	Ответ = Новый HTTPСервисОтвет(200);
	
	// Получаем объект в котором содержится результат работы процедур
	РезультатРаботы = MODCOMM_ОбщегоНазначения.СтруктураРезультатаОбработок("Загрузка поступление товаров");
	
	#Область ПолучениеJSONДанных
	СтрокаJSON = Запрос.ПолучитьТелоКакСтроку();
	Документы = MODCOMM_ОбщегоНазначения.ПолучитьСтруктуруИзСтрокиJSON( СтрокаJSON );	
	Если Документы = Неопределено Или ТипЗнч(Документы) <> Тип("Массив") Тогда 
		// Неверный формат JSON
		РезультатРаботы.Ошибки.Добавить( СтрокаJSON );
	...
	ВременныеЗаголовки = ПриобретениеТоваровУслугЗаголовокТаблицаЗначений();
	ВременныеДетали = ПриобретениеТоваровУслугДеталиТаблицаЗначений();
		
	ВосстанавливаемыеДанные = ВосстанавливаемыеДанныеТаблицаЗначений();	
	ЗаполнитьВосстанавливаемыеДанные( ВосстанавливаемыеДанные, "ПриобретениеТоваровУслугЗаголовки" );
...
Функция ПриобретениеТоваровУслугПолучить(Запрос)
	Ответ = Новый HTTPСервисОтвет(200);
	
	
	Ответ.УстановитьТелоИзСтроки( "Привет - Получить", КодировкаТекста.UTF8 );
	Возврат Ответ;
КонецФункции
